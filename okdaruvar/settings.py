"""
Django settings for okdaruvar project.
...
SECRET_KEY = 'django-insecure-y^kzs%gqbu4i2g@rqz%z*!(jt2-p6w%lkcnw58wfu!cfkrvw7c'
...
WSGI_APPLICATION = 'okdaruvar.wsgi.application'
